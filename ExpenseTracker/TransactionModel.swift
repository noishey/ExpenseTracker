...
extension Category {
    ...
    static let publicTransportation = Category(id: 10, name: "Public Transportation", icon: .bus, mainCategoryId: 1)
    static let mobilePhone = Category(id: 11, name: "Mobile Phone", icon: .mobile_alt, mainCategoryId: 2)
    static let groceries = Category(id: 12, name: "Groceries", icon: .shopping_basket, mainCategoryId: 5)
    static let restaurants = Category(id: 13, name: "Restaurants", icon: .utensils, mainCategoryId: 5)
    static let rent = Category(id: 14, name: "Rent", icon: .house_user, mainCategoryId: 6)
    static let utilities = Category(id: 15, name: "Utilities", icon: .lightbulb, mainCategoryId: 2)
    static let creditCardPayment = Category(id: 99, name: "Credit Card Payment", icon: .exchange_alt, mainCategoryId: 9)
    static let taxi = Category(id: 101, name: "Taxi", icon: .taxi, mainCategoryId: 1)
    ...
    static let homeSupplies = Category(id: 601, name: "Home Supplies", icon: .lightbulb, mainCategoryId: 6)
    static let paycheck = Category(id: 701, name: "Paycheque", icon: .dollar_sign, mainCategoryId: 7)
